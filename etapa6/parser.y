...
programa: decl {$$=$1; ASTroot=$$; TAC *code; astPrint($$,0); check_and_set_declarations($1); check_undeclared(); code = generateCode($1); tacPrintBackwards(code); code = tacReverse(code); addDataVarHash($1);generateAsm(code, $1);}
	;
